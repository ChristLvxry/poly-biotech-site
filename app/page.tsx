...
const StyleInjection = () => (
  <style>{`
    ...
    .prose-sm h3 { font-family: var(--font-heading); font-weight: 700; color: #064e3b; margin-top: 1rem; margin-bottom: 0.5rem; }
    .prose-sm ul { list-style-type: disc; padding-left: 1.5rem; margin-bottom: 1rem; }
    .prose-sm li { margin-bottom: 0.25rem; }
    .prose-sm strong { color: #065f46; font-weight: 600; }
